...
import type { IUserRepository, UserRow } from '../../../types/interfaces/users/user.repository.interface.js';
...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    it('should create and return a new user (happy path)', async () => {
      ...
      vi.mocked(userRepositoryMock.create).mockResolvedValue({ ...mockUserRow, ...createData });
  ...
  describe('updateUser', () => {
    it('should update and return user when id exists (happy path)', async () => {
      ...
      vi.mocked(userRepositoryMock.update).mockResolvedValue({ ...mockUserRow, ...updateData });
