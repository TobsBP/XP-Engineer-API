...
export interface IQuizRepository {
	...
	createQuestionWithOptions(data: CreateQuizQuestionData): Promise<QuizQuestionWithOptions>;
	updateQuestion(id: number, data: UpdateQuizQuestionData): Promise<QuizQuestionWithOptions | null>;
