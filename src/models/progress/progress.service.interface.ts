...
export interface IProgressService {
	...
	completeLesson(userId: number, moduleId: string, page: number): Promise<LessonCompleteResponse>;
	completeModule(userId: number, moduleId: string, answers: AnswerInput[]): Promise<ModuleCompleteResponse>;
}
